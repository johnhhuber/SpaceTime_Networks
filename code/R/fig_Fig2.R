...
# load scalar files for each of the different scenarios
files = list.files(path.in, pattern = 'scalars_pooled.csv', recursive = T, full.names = T)
...
# plot 
tiff(filename = paste(path.out, 'Fig2.tiff', sep = ''), width = 1.25 * 6, height = 6, units = 'in', res = 300, compression = 'lzw')
...
hist(scalars[[2]]$diffusion_coef, col = col2alpha(palette[2], alpha = 0.8), border = 'white',
     xlab = '', ylab = '', main = '', las = 1, xlim = c(0,10), ylim = c(0,0.6), yaxs ='i', xaxs = 'i', axes = FALSE, freq = FALSE)
...
mtext(text = 'A', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)
...
axis(side = 1, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
axis(side = 2, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
title(xlab = '', ylab = 'Density', font.lab = 1, cex.lab = 1.5, col = '#222222')
mtext(text = 'D', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)
...
axis(side = 2, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
title(xlab = '', ylab = 'Density', font.lab = 1, cex.lab = 1.5, col = '#222222')
mtext(text = 'G', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

plot.new()
title(xlab = '', ylab = 'Density', font.lab = 1, cex.lab = 1.5)
legend('center', legend = c('NA'), text.col = palette[5], bty = 'n', cex = 1.5)
mtext(text = 'J', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

plot.new()
title(xlab = '', ylab = 'Density', font.lab = 1, cex.lab = 1.5)
legend('center', legend = c('NA'), text.col = palette[4], bty = 'n', cex = 1.5)
mtext(text = 'M', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

par(mar=c(3.1,3.5,1.1,0.1))
hist(scalars[[2]]$tau_s, col = col2alpha(palette[2], alpha = 0.0), border = 'white',
     xlab = '', ylab = '', main = '', las = 1, xlim = c(0,1), ylim = c(0,4.5), axes = FALSE, yaxs = 'i', xaxs = 'i', freq = FALSE)
...
hist(scalars[[2]]$tau_s, col = col2alpha(palette[2], alpha = 0.8), border = 'white',
     xlab = '', ylab = '', main = '', las = 1, xlim = c(0,1), ylim = c(0,4.5), axes = FALSE, yaxs = 'i', xaxs = 'i', freq = FALSE, add = T)
axis(side = 1, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
axis(side = 2, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
title(xlab = '', ylab = '', font.lab = 1, cex.lab = 1.5, col = '#222222')
mtext(text = expression(tau['s']), side = 3, line = 1, cex = 1, font = 2)
mtext(text = expression(underline('Parameters')), side = 3, line = 3, cex = 1, font = 1, col = '#222222')
mtext(text = 'B', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

par(mar=c(3.1,3.5,2.1,0.1))
plot.new()
legend('center', legend = c('NA'), text.col = palette[1], bty = 'n', cex = 1.5)
mtext(text = 'E', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

plot.new()
legend('center', legend = c('NA'), text.col = palette[3], bty = 'n', cex = 1.5)
mtext(text = 'H', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)
...
axis(side = 2, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
title(xlab = '', ylab = '', font.lab = 1, cex.lab = 1.5, col = '#222222')
mtext(text = 'K', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)


plot.new()
legend('center', legend = c('NA'), text.col = palette[4], bty = 'n', cex = 1.5)
mtext(text = 'N', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

par(mar=c(3.1,3.5,1.1,1.1))
hist(scalars[[2]]$tau_l, col = col2alpha(palette[2], alpha = 0.0), border = palette[2],
     xlab = '', ylab = '', main = '', las = 1, xlim = c(0,1), ylim = c(0,25), axes = FALSE, yaxs = 'i', xaxs = 'i', freq = FALSE)
polygon(x = c(seq(from = 0, to = 1, by = 0.01), rev(seq(from = 0, to = 1, by = 0.01))), c(dbeta(seq(from = 0, to = 1, by = 0.01), 3, 12), rep(0, length(seq(from = 0, to = 1, by = 0.01)))),
        col = adjustcolor('#222222', 0.4), border = NA)
hist(scalars[[2]]$tau_l, col = col2alpha(palette[2], alpha = 0.8), border = palette[2],
     xlab = '', ylab = '', main = '', las = 1, xlim = c(0,1), ylim = c(0,25), axes = FALSE, yaxs = 'i', xaxs = 'i', freq = FALSE, add = T)
axis(side = 1, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
axis(side = 2, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
title(xlab = '', ylab = '', font.lab = 1, cex.lab = 1.5, col = '#222222')
mtext(text = expression(tau['l']), side = 3, line = 1, cex  = 1, col = '#222222', font = 2)
mtext(text = 'C', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

par(mar=c(3.1,3.5,2.1,0.1))
plot.new()
legend('center', legend = c('NA'), text.col = palette[1], bty = 'n', cex = 1.5)
mtext(text = 'F', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

plot.new()
legend('center', legend = c('NA'), text.col = palette[3], bty = 'n', cex = 1.5)
mtext(text = 'I', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)
...
axis(side = 2, lwd = 1.5, las = 1, col = '#222222', col.axis = '#222222')
title(xlab = '', ylab = '', font.lab = 1, cex.lab = 1.5, col = '#222222')
mtext(text = 'L', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

plot.new()
legend('center', legend = c('NA'), text.col = palette[4], bty = 'n', cex = 1.5)
mtext(text = 'O', side = 3, line = 1, cex = 1, col = '#222222', at = 0, font = 1)

par(mar=c(2.1,1.1,1.5,0.1))

# data sources included
plot.new()
mtext(text = expression(underline('Inference Settings')), side = 3, line = 3, cex = 1, font = 1, adj = 0, col = '#222222')
...
mtext(expression('Travel:' * phantom(' Ignore')), col = '#222222', side = 1, line = -1.25, cex = 1, adj = 0)
mtext(expression(phantom('Travel:') * ' Ignore'), col = palette[3], side = 1, line = -1.25, cex = 1, adj = 0)
...
legend('bottom', legend = c('Prior Distribution'),
       pch = 15, col = adjustcolor('#222222', 0.4), bty = 'n', xpd = TRUE, horiz = TRUE, cex = 1, pt.cex = 2, inset = c(-20,0))
